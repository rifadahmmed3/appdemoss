      ...
      <div className='flex flex-col items-center md:w-[100%] lg:w-[70%] justify-center p-10 bg-slate-100 border border-gray-200'>
       <Image src="/logo.png" width={200} height={200} alt='logo'/>
        ...
        <div className='w-full flex flex-col gap-5 mt-7'>
            <Input placeholder="Email or Username" onChange={(e)=>setEmail(e.target.value)}/>
            <Input type="password" placeholder="Password" onChange={(e)=>setPassword(e.target.value)}/>
            
            <Button id='signbtn' onClick={()=>onSignIn()} disabled={!(email&&password)} > {loader? <LoaderIcon className="animate-spin" />:'Sign In'}</Button>
