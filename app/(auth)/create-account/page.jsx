    ...
    <div className='flex items-baseline justify-center my-10 mt-10'>
      <div className='flex flex-col items-center md:w-[100%] lg:w-[70%] justify-center p-10 bg-slate-100 border border-gray-200'>
        ...
        <div className='w-full flex flex-col gap-5 mt-7'>
            ...
            <Button id='signupbtn' onClick={()=>onCreateAccount()} disabled={!(username && fullname && fathername && email && password && address && phone && nidorbirth && nomeneeName && nomeneePhone)}> {loader? <LoaderIcon className="animate-spin" />:'Sign Up'}</Button>
